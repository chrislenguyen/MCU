...
# 10 "/opt/microchip/xc8/v2.10/pic/include/c99/math.h" 3
...
void slowDecrease() {
    ...
    if (countD > 3000/20 && countI == 0) {
        state = FAST_DECREASE;
    }
    if (slowCount > 500/20 && countI == 0) {
        LATD--;
        slowCount = 0;
    }
}
