...
# 122 "./LCD.h"
    ...
    void LCDCursorControl(unsigned char line, unsigned char pos);
# 16 "./Initialization.h" 2
# 1 "./Read_Button.h" 1
# 15 "./Read_Button.h"
    char readButtonRA5();
    char readButtonRB0();
# 17 "./Initialization.h" 2
# 1 "./Interrupt_Tmr.h" 1
# 15 "./Interrupt_Tmr.h"
    void __attribute__((picinterrupt(("")))) ITR(void);
# 18 "./Initialization.h" 2
# 1 "./Button.h" 1
# 15 "./Button.h"
    void button();
# 19 "./Initialization.h" 2
# 1 "./Mod_Time.h" 1
# 15 "./Mod_Time.h"
    void modSecond();
    void modMinute();
    void modHour();
    void blink();
# 20 "./Initialization.h" 2
# 1 "./Normal_Clock.h" 1
# 15 "./Normal_Clock.h"
    void handleTime();
    void dispClock();
    void normalClock();
# 21 "./Initialization.h" 2
# 1 "./Stop_Watch.h" 1
# 15 "./Stop_Watch.h"
    void dispSw();
    void handleTimeSw();
    void stopWatch();
# 22 "./Initialization.h" 2
...
void calculate_init_tmr() {
     timerCounter = powf(2,16) - (int)((10) * (2 * powf(10,3)));
}
