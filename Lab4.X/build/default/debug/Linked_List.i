...
void init_arr_task(void) {
    ...
    while (index < 20) {
        ...
        arr_task[index].pTask = ((void*)0);
        arr_task[index].data = ((void*)0);
        index++;
    }
}
...
uint64_t add_task(uint64_t delay, uint64_t period, void(*callback)(), void *data) {
    ...
    if (size == 0) {
        ...
        while (arr_task[index].pTask != ((void*)0) && index < 20) {
            index++;
        ...
        if (delay < arr_task[cur].delay) {
            ...
            arr_task[temp].delay -= arr_task[index].delay;
        }
...
void remove_task(uint32_t id) {
    ...
    arr_task[id].pTask = ((void*)0);
    arr_task[id].data = ((void*)0);
    size--;
}
...
void dispatch_task(void) {
    if (arr_task[list_head].run_flag > 0) {
        ...
        if (tempNode.period != 0) {
           tempNode.delay = tempNode.period;
